    ...
    <div class="row">
        <? foreach ($arResult["PROPERTY_LIST"] as $propertyCode => $property) {
            switch ($property["TYPE"]) {
                case "T":
                    ?>
                    <div class="col-xs-12 form-group <? if ($property["ERRROR"] == "Y") {
                        echo "has-error";
                    } ?>">
                ...
                case "EMAIL":
                    ?>
                    <div class="col-xs-4 form-group <? if ($property["ERRROR"] == "Y") {
                        echo "has-error";
                    } ?>">
                        <div class="row">
                            <div class="col-xs-12 ">
                ...
                case "PHONE":
                    ...
                    <div class="col-xs-4 form-group <? if ($property["ERRROR"] == "Y") {
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 ">
                                <input class="form-control" type="tel" name="<?= $propertyCode ?>" <?= ($property["REQUARED"] == 1) ? "required" : "" ?> value="<?= $property["VALUE"] ?>"/>
                            </div>
                        </div>
                    </div>
                    <?
                    ...
                    <div class="col-xs-4  form-group <? if ($property["ERRROR"] == "Y") {
                        ...
                        <div class="row">
                            <div class="col-xs-12 ">
                                <label class="control-label <? if ($property["REQUARED"]) {
                                    echo "required";
                                } ?>" for="<?= $propertyCode ?>"><?= $property["NAME"] ?>
                                </label>
                            </div>
                            <div class="col-xs-12 ">
